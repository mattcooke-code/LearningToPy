    ...
    return (
      <div className="rounded-2xl bg-gradient-to-br from-purple-50 to-indigo-50 dark:from-purple-900/20 dark:to-indigo-900/20 p-6 shadow-md border border-purple-200 dark:border-purple-800">
        ...
        <div className="space-y-4">
          ...
          <button
            onClick={onOptIn}
            className="w-full inline-flex items-center justify-center px-4 py-2 bg-purple-800 dark:bg-purple-400 dark:text-purple-950 text-white rounded-lg hover:bg-purple-700 dark:hover:bg-purple-600 transition-colors text-sm font-medium"
          >
