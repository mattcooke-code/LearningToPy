        ...
        {isCourseComplete ? (
          <>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Link
                to="/modules"
                className="px-6 py-3 rounded-lg font-semibold transition inline-flex items-center bg-theme hover:bg-theme-hover text-theme-text"
              >
          ...
          <>
            ...
            <Link
              to={`/modules`}
              className="px-8 py-3 rounded-lg font-semibold transition inline-flex items-center bg-theme hover:bg-theme-hover text-theme-text"
            >
