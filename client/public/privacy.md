...
- [Learning To Py — Privacy Notice](#learning-to-py--privacy-notice)
  ...
  - [Lawful bases and data protection rights](#lawful-bases-and-data-protection-rights)
    - [Our lawful bases for the collection and use of your data](#our-lawful-bases-for-the-collection-and-use-of-your-data)
  - [Exercising your rights on our platform](#exercising-your-rights-on-our-platform)
  ...
  - [Who we share information with](#who-we-share-information-with)
    ...
    - [Others we share personal information with](#others-we-share-personal-information-with)
...
- Date of birth _(see note below)_
...
We collect basic usage data to provide and improve the learning platform. This includes:

- Pages and lessons you view
- Quiz attempts and scores
- Exercises you complete
- Time spent on lessons
- Features you interact with

This data is **strictly necessary** for:

- Tracking your learning progress
- Awarding XP, badges, and streak rewards
- Showing you where you left off
- Generating your personal statistics and leaderboard rankings

Without this data, the platform cannot function as a learning management system.
...
We use one essential cookie to keep our platform functioning:

| Cookie         | Purpose                                                                    | Duration                                                        |
| -------------- | -------------------------------------------------------------------------- | --------------------------------------------------------------- |
| `refreshToken` | Keeps you logged into the platform so you don't have to sign in repeatedly | 1 hour (or 30 days if you select "Remember Me" when logging in) |

This cookie is **strictly necessary** for the platform to work. It does not track you across other websites, and we do not use it for advertising or marketing purposes.

Under UK data protection law, strictly necessary cookies do not require your consent, but we disclose them here for transparency.
...
## Exercising your rights on our platform
...
- Organisations we're legally obliged to share personal information with (for example, law enforcement or regulatory bodies when required by law).
