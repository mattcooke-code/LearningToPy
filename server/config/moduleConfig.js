...
const MODULE_CONFIGS = {
  ...
  M10: {
    ...
    lessons: [
      ...
      {
        file: "L3_Advanced_Args_Kwargs.md",
        quiz: "L3_Quiz.json",
      ...
      {
        file: "L4_Function_Decorators.md",
        quiz: "L4_Quiz.json",
      ...
      {
        file: "L5_Functional_Programming_Tools.md",
        quiz: "L5_Quiz.json",
      ...
      {
        file: "L6_Project_Function_Toolkit.md",
  ...
  M17: {
    ...
    lessons: [
      ...
      {
        file: "L6_Project_Sales_Analysis.md",
        title: "Project: Sales Analysis with NumPy and Pandas",
        type: "project",
        ex: "L6_Exercise.json",
      },
    ],
