...
- Text (strings) must be wrapped in quotation marks
- Quotation marks must match (both single or both double)

In the next lesson, you'll learn how to add helpful notes to your code using comments, and understand why indentation matters in Python.
