# 💻 Module Project: Simple Calculator

Congratulations! You've mastered Python's basic building blocks: syntax, variables, types, and operators. Now it's time to put all those skills together.

In this final challenge for the module, you will build a tiny, functional calculator.
