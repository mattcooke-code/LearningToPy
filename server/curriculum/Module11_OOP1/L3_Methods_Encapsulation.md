...
Objects aren't just containers for data; they also perform actions. In OOP, the actions an object can perform are defined by **methods**.
...
In Python, we achieve a form of encapsulation using access modifiers:
...
# Create an object
safe_account = SafeBankAccount("Charlie", 200)
